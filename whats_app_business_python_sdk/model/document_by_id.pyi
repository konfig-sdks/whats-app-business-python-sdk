...
class DocumentById(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["caption", "filename", "id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["caption", "filename", "id", ], str]):
