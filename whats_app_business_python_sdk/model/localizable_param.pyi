...
class LocalizableParam(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def date_time() -> typing.Type['DateTimeObject']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["date_time"]) -> 'DateTimeObject': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["default", "currency", "date_time", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["date_time"]) -> typing.Union['DateTimeObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["default", "currency", "date_time", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        date_time: typing.Union['DateTimeObject', schemas.Unset] = schemas.unset,
