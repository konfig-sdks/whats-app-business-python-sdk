...
class RestoreSettingsRequestBody(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["data", "password", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["data", "password", ], str]):
