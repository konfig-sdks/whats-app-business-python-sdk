...
class WebhookAudio(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["caption", "file", "filename", "id", "link", "mime_type", "sha256", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["caption", "file", "filename", "id", "link", "mime_type", "sha256", ], str]):
