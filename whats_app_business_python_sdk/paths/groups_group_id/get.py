...
from whats_app_business_python_sdk.model.group_response import GroupResponse as GroupResponseSchema

from whats_app_business_python_sdk.type.group_response import GroupResponse

from ...api_client import Dictionary
from whats_app_business_python_sdk.pydantic.group_response import GroupResponse as GroupResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GroupResponseSchema
...
class GetInfo(BaseApi):
    ...
    async def aget_info(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GroupResponsePydantic:
        raw_response = await self.raw.aget_info(
            group_id=group_id,
            **kwargs,
        )
        if validate:
            return RootModel[GroupResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GroupResponsePydantic, raw_response.body)
