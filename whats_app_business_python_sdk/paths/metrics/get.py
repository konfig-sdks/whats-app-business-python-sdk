...
class BaseApi(api_client.Api):
    ...
    def _get_metrics_data_mapped_args(
        self,
    ...
    async def _aget_metrics_data_oapg(
        self,
...
class GetMetricsDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_metrics_data(
        self,
        format: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_metrics_data_mapped_args(
            format=format,
        )
        return await self._aget_metrics_data_oapg(
    ...
    def get_metrics_data(
        ...
        return self._get_metrics_data_oapg(
            query_params=args.query,
        )

class GetMetricsData(BaseApi):
    ...
    async def aget_metrics_data(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_metrics_data(
            format=format,
            **kwargs,
        )
        if validate:
    ...
    def get_metrics_data(
        ...
        raw_response = self.raw.get_metrics_data(
            format=format,
        )
        if validate:
            return Dictionary(**raw_response.body)
