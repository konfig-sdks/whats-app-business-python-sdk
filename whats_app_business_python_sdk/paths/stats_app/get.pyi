...
class BaseApi(api_client.Api):
    ...
    def _get_app_stats_mapped_args(
        self,
    ...
    async def _aget_app_stats_oapg(
        self,
...
class GetAppStatsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_app_stats(
        self,
        format: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_app_stats_mapped_args(
            format=format,
        )
        return await self._aget_app_stats_oapg(
    ...
    def get_app_stats(
        ...
        return self._get_app_stats_oapg(
            query_params=args.query,
        )

class GetAppStats(BaseApi):
    ...
    async def aget_app_stats(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_app_stats(
            format=format,
            **kwargs,
        )
        if validate:
    ...
    def get_app_stats(
        ...
        raw_response = self.raw.get_app_stats(
            format=format,
        )
        if validate:
            return Dictionary(**raw_response.body)
