...
class GetDbStatsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_db_stats(
        self,
        format: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_db_stats_mapped_args(
            format=format,
        )
        return await self._aget_db_stats_oapg(
    ...
    def get_db_stats(
        ...
        return self._get_db_stats_oapg(
            query_params=args.query,
        )

class GetDbStats(BaseApi):
    ...
    async def aget_db_stats(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_db_stats(
            format=format,
            **kwargs,
        )
        if validate:
    ...
    def get_db_stats(
        ...
        raw_response = self.raw.get_db_stats(
            format=format,
        )
        if validate:
            return Dictionary(**raw_response.body)
